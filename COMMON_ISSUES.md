...
Firefox 64/65 Participants sometimes experience ICE failures in Group Rooms
---------------------------------------------------------------------------

Firefox 64 introduced a [regression](https://bugzilla.mozilla.org/show_bug.cgi?id=1526477)
in its ICE agent which sometimes results in ICE failures when interacting with
