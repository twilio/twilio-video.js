...
New Features
------------
- twilio-video.js now supports WKWebView and SFSafariViewController on iOS version 14.3 or later. The `isSupported` flag relies partly on the [User-Agent string](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent) to determine if twilio-video.js officially supports the user's browser. If your application modifies the default value for the User-Agent heading, the string value should follow the correct syntax.
