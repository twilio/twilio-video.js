...
function createRoomSignaling(client, identities, nameOrSid, options, localParticipant) {
  return getIceServers(client, options).then(function(iceServers) {
    options.iceServers = iceServers;
    return client._signaling.connect(identities, nameOrSid, localParticipant._signaling, options);
  });
}
