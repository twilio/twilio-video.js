...
Client.prototype.inviteToConversation = function inviteToConversation(identities, options) {
  ...
  options = util.withDefaults({}, this._options, options);
  var conversationSid = null;
  return new OutgoingInvite(identities,
    getLocalMedia.bind(null, this, options),
    createOutgoingInviteImpl.bind(null, this, identities, conversationSid, options),
...
function createConversation(client, options, conversationImpl) {
...
function createOutgoingInviteImpl(client, identities, conversationSid, options, localMedia) {
...
function getLocalMedia(client, options, handleLocalMedia) {
  options = Object.assign({
    shouldStopLocalMedia: !(options && (options.localMedia || options.localStream))
  }, options);
