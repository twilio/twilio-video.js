...
Client.prototype.connect = function connect(options) {
  ...
  options.with = options.with instanceof Array
    ? options.with
    : [options.with];
  return new OutgoingInvite(options.with,
    getLocalMedia.bind(null, this, options),
    createOutgoingInviteSignaling.bind(null, this, options.with, options.labelOrSid, options),
 ...
 * @property {?Array<string>|string} [with=null] - Set to one or more identities
 *   to invite Participants when connecting to a {@link Room}
 */
