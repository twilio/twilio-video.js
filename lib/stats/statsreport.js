  ...
  constructor(peerConnectionId, statsResponse, prepareForInsights) {
    ...
    Object.defineProperties(this, {
      ...
      remoteAudioTrackStats: {
        value: statsResponse.remoteAudioTrackStats.map(report => new RemoteAudioTrackStats(report.trackId, report, prepareForInsights)),
        enumerable: true
      },
      remoteVideoTrackStats: {
        value: statsResponse.remoteVideoTrackStats.map(report => new RemoteVideoTrackStats(report.trackId, report, prepareForInsights)),
        enumerable: true
      }
    });
  }
