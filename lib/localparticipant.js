...
var ParticipantSignaling = require('./signaling/participant');
 ...
 */
function LocalParticipant(localMedia) {
  if (!(this instanceof LocalParticipant)) {
    return new LocalParticipant(localMedia);
  }
  Participant.call(this, new ParticipantSignaling(), localMedia);
}
