 ...
 * @param {LocalTrack} track - The {@link LocalTrack} to publish
 ...
 * @param {MediaStreamTrack} track - The MediaStreamTrack to publish
 * @returns {Promise<LocalTrackPublication>} - Resolves with the corresponding
 *    {@link LocalTrackPublication} if successful
 * @fires Participant#trackAdded
 */
 ...
 * @param {Array<LocalTrack>} tracks - The {@link LocalTrack}s to publish
 * @returns {Promise<Array<LocalTrackPublication>>} - The resulting
 *   {@link LocalTrackPublication}s
 * @fires Participant#trackAdded
 * @throws {TypeError}
 *//**
 * Publishes multiple MediaStreamTracks to the {@link Room}.
 * @param {Array<MediaStreamTrack>} tracks - The MediaStreamTracks to publish
 * @returns {Promise<Array<LocalTrackPublication>>} - The resulting
 *    {@link LocalTrackPublication}s
 * @fires Participant#trackAdded
 * @throws {TypeError}
 ...
 * @param {Array<LocalTrack>} tracks - The {@link LocalTrack}s to stop publishing
 * @returns {Array<LocalTrack>} - The corresponding {@link LocalTrackPublication}s
 *    that were successfully unpublished
 * @fires Participant#trackRemoved
 * @throws {TypeError}
 *//**
 * Stops publishing multiple MediaStreamTracks to the {@link Room}.
 * @param {Array<MediaStreamTrack>} tracks - The MediaStreamTracks to stop publishing
 * @returns {Array<LocalTrack>} - The corresponding {@link LocalTrackPublication}s
 *    that were successfully unpublished
 * @fires Participant#trackRemoved
 * @throws {TypeError}
