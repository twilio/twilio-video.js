...
LocalParticipant.prototype._handleTrackSignalingEvents = function _handleTrackSignalingEvents() {
  ...
  function localTrackAdded(localTrack) {
    signaling.addTrack(localTrack._dataStreamTrack || localTrack.mediaStreamTrack);
  ...
  function localTrackRemoved(localTrack) {
    signaling.removeTrack(localTrack._dataStreamTrack || localTrack.mediaStreamTrack);
...
/**
 * Publishes a {@link LocalAudioTrack} to the {@link Room}.
 * @param {LocalAudioTrack|MediaStreamTrack} track - The {@link LocalAudioTrack}
 *   to publish; if an audio MediaStreamTrack is provided, and a corresponding
 *   {@link LocalAudioTrack} has not yet been published, this method will
 *   construct one
 * @returns {Promise<LocalAudioTrackPublication>} - Resolves with the
 *   corresponding {@link LocalAudioTrackPublication} if successful
 * @fires Participant#trackAdded
*//**
 * Publishes a {@link LocalVideoTrack} to the {@link Room}.
 * @param {LocalVideoTrack|MediaStreamTrack} track - The {@link LocalVideoTrack}
 *   to publish; if a video MediaStreamTrack is provided, and a corresponding
 *   {@link LocalVideoTrack} has not yet been published, this method will
 *   construct one
 * @returns {Promise<LocalVideoTrackPublication>} - Resolves with the
 *   corresponding {@link LocalVideoTrackPublication} if successful
 * @fires Participant#trackAdded
*//**
 * Publishes a {@link LocalDataTrack} to the {@link Room}.
 * @param {LocalDataTrack} track - The {@link LocalDataTrack} to publish
 * @returns {Promise<LocalDataTrackPublication>} - Resolves with the
 *   corresponding {@link LocalDataTrackPublication} if successful
 * @fires Participant#trackAdded
 */
...
/**
 * Removes a {@link LocalAudioTrack} from the {@link LocalParticipant}.
 * @deprecated Use {@link LocalParticipant#unpublishTrack} instead
 * @param {LocalAudioTrack|MediaStreamTrack} track - The {@link LocalAudioTrack}
 *   to remove; if an audio MediaStreamTrack is provided, this method looks up
 *   the corresponding {@link LocalAudioTrack} to remove
 * @param {?boolean} [stop=true] - Whether or not to call
 *   {@link LocalAudioTrack#stop}
 * @returns {?LocalAudioTrack} - The {@link LocalAudioTrack} removed, otherwise
 *   null
 * @fires Participant#trackRemoved
 * @throws {TypeError}
*//**
 * Removes a {@link LocalVideoTrack} from the {@link LocalParticipant}.
 * @deprecated Use {@link LocalParticipant#unpublishTrack} instead
 * @param {LocalVideoTrack|MediaStreamTrack} track - The {@link LocalVideoTrack}
 *   to remove; if a video MediaStreamTrack is provided, this method looks up
 *   the corresponding {@link LocalVideoTrack} to remove
 * @param {?boolean} [stop=true] - Whether or not to call
 *   {@link LocalVideoTrack#stop}
 * @returns {?LocalVideoTrack} - The {@link LocalVideoTrack} removed, otherwise
 *    null
 * @fires Participant#trackRemoved
 * @throws {TypeError}
*//**
 * Removes a {@link LocalDataTrack} from the {@link LocalParticipant}.
 * @deprecated Use {@link LocalParticipant#unpublishTrack} instead
 * @param {LocalDataTrack} track - The {@link LocalDataTrack} to remove
 * @returns {?LocalDataTrack} - The {@link LocalDataTrack} removed, otherwise
 *    null
 * @fires Participant#trackRemoved
 * @throws {TypeError}
 */
...
/**
 * Stops publishing a {@link LocalAudioTrack} to the {@link Room}.
 * @param {LocalAudioTrack|MediaStreamTrack} track - The {@link LocalAudioTrack}
 *   to stop publishing; if an audio MediaStreamTrack is provided, this method
 *   looks up the corresponding {@link LocalAudioTrack} to stop publishing
 * @returns {?LocalAudioTrackPublication} - The corresponding
 *   {@link LocalAudioTrackPublication} if the {@link LocalAudioTrack} was
 *   previously published, null otherwise
 * @fires Participant#trackRemoved
 * @throws {TypeError}
*//**
 * Stops publishing a {@link LocalVideoTrack} to the {@link Room}.
 * @param {LocalVideoTrack|MediaStreamTrack} track - The {@link LocalVideoTrack}
 *   to stop publishing; if a video MediaStreamTrack is provided, this method
 *   looks up the corresponding {@link LocalVideoTrack} to stop publishing
 * @returns {?LocalVideoTrackPublication} - The corresponding
 *   {@link LocalVideoTrackPublication} if the {@link LocalVideoTrack} was
 *   previously published, null otherwise.
 * @fires Participant#trackRemoved
 * @throws {TypeError}
*//**
 * Stops publishing a {@link LocalDataTrack} to the {@link Room}.
 * @param {LocalDataTrack} track - The {@link LocalDataTrack} to stop publishing
 * @returns {?LocalDataTrackPublication} - The corresponding
 *   {@link LocalDataTrackPublication} if the {@link LocalDataTrack} was
 *   previously published, null otherwise.
 * @fires Participant#trackRemoved
 * @throws {TypeError}
 */
LocalParticipant.prototype.unpublishTrack = function unpublishTrack(track) {
  ...
  if (localTrackPublication) {
    publishedKindTracks.delete(localTrackPublication.sid);
    this.trackPublications.delete(localTrackPublication.sid);
  }
...
/**
 * @private
 * @param {Map<Track.SID, TrackPublication>} trackPublications
 * @param {Track|MediaStreamTrack} track
 * @returns {TrackPublication?} trackPublication
 */
