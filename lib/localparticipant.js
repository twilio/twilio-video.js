 ...
 * @param {LocalTrack} localTrackOrMediaStreamTrack - The {@link LocalTrack} to publish
 ...
 * @param {MediaStreamTrack} localTrackOrMediaStreamTrack - The MediaStreamTrack
 ...
 *   console.log('The LocalTrack: '
 *     + localTrackPublication.trackName
...
LocalParticipant.prototype.publishTrack = function publishTrack(localTrackOrMediaStreamTrack, options) {
  ...
  try {
    var localTrack = util.asLocalTrack(localTrackOrMediaStreamTrack, options);
  } catch (error) {
