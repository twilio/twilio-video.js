  ...
  _getOrCreateLocalTrackPublication(localTrack) {
    ...
    return new Promise((resolve, reject) => {
      function updated() {
        ...
        localTrackPublication.on('warning', twilioWarningName => {
          self.emit('trackWarning', twilioWarningName, localTrackPublication);
        });

        localTrackPublication.on('warningsCleared', () => {
...
/**
 * One of the {@link LocalParticipant}'s {@link LocalTrackPublication}s encountered a {@link TwilioWarning}.
 * @param {TwilioWarning} name - The {@link TwilioWarning} that was raised.
 * @param {LocalTrackPublication} publication - The {@link LocalTrackPublication} that encountered the {@link TwilioWarning}.
 * @event LocalParticipant#trackWarning
 */

/**
 * One of the {@link LocalParticipant}'s {@link LocalTrackPublication}s cleared all {@link TwilioWarning}s.
 * @param {LocalTrackPublication} publication - The {@link LocalTrackPublication} that cleared all {@link TwilioWarning}s.
