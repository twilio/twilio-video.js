 ...
 * @property {number} networkQuality - The {@link LocalParticipant}'s network
 *   quality level; network quality is measured from one to five where one means
 *   "poor" and five means "great"; if you have a consistently low network
 *   quality level, consider unpublishing {@link LocalTrack}s or changing
 *   networks; if a network quality level has not yet been computed, this
 *   property is zero
 ...
 * @fires LocalParticipant#networkQualityChanged
...
/**
 * Set the {@link LocalParticipant}'s network quality level.
 * @private
 * @param {number} networkQualityLevel
 * @returns {void}
 */
LocalParticipant.prototype._setNetworkQualityLevel = function _setNetworkQualityLevel(networkQualityLevel) {
  this._networkQuality = networkQualityLevel;
  this.emit('networkQualityChanged', networkQualityLevel);
};
...
/**
 * The {@link LocalParticipant}'s network quality changed. Network quality is
 * measured from one to five where one means "poor" and five means "great". If
 * you have a consistently low network quality level, consider unpublishing
 * {@link LocalTrack}s or changing networks.
 * @param {number} networkQualityLevel - The {@link LocalParticipant}'s
 *   network quality level
 * @event LocalParticipant#networkQualityChanged
 */
