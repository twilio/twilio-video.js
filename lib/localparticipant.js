...
class LocalParticipant extends Participant {
  ...
  *//**
  ...
  publishTrack(localTrackOrMediaStreamTrack, options) {
    ...
    const noiseCancellationVendor = localTrack.noiseCancellation?.vendor;
    if (noiseCancellationVendor && !this._signaling.audioProcessors.includes(noiseCancellationVendor))  {
      // this room does not support this vendor.
      return Promise.reject(new Error(`${noiseCancellationVendor} is not supported in this room`));
    }
