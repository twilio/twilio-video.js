...
navigator.getUserMedia = function getUserMedia(constraints, successCallback, errorCallback) {
...
global.RTCPeerConnection = function RTCPeerConnection(configuration, constraints) {
...
global.RTCSessionDescription = function RTCSessionDescription(sdp) {
  this.type = 'offer';
...
global.attachMediaStream = function attachMediaStream() {
};

var URL = global.URL = function URL() {
};
...
URL.revokeObjectURL = function revokeObjectURL(blob) {
};
