...
function rollback(peerConnection, local, onceRolledBack) {
  ...
  return peerConnection._peerConnection[setLocalDescription](new RTCSessionDescription({
    type: 'rollback'
