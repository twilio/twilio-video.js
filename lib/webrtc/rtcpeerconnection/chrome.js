...
class ChromeRTCPeerConnection extends EventTarget {
  constructor(configuration, constraints) {
    ...
    // console.log('mid', this._peerConnection);
    ...
    // inherits(ChromeRTCPeerConnection, RTCPeerConnection);
