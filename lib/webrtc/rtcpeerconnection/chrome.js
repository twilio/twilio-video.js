...
class ChromeRTCPeerConnection extends EventTarget {
  ...
  get localDescription() {
    return this._pendingLocalOffer ? this._pendingLocalOffer : this.peerConnection.localDescription;
  }

  get remoteDescription() {
    return this._pendingRemoteOffer ? this._pendingRemoteOffer : this.peerConnection.remoteDescription;
  }
  ...
  createOffer(...args) {
    ...
    return args.length > 1
      ? legacyPromise(promise, args[0], args[1])
      : promise;
  }
