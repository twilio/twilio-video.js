...
const { PUBLISHER_METADATA_IPAD } = require('../constants');
const util = require('../../util');
const { isIpad } = require('../browserdetection');
...
function connect(publisher, token, sdkName, sdkVersion, roomSid, participantSid, options) {
  ...
  ws.addEventListener('open', () => {
    ...
    if (isIpad()) {
      connectRequest.publisher = { ...connectRequest.publisher, ...PUBLISHER_METADATA_IPAD };
      // connectRequest.publisher = Object.assign(connectRequest.publisher, PUBLISHER_METADATA_IPAD);
    }
