...
function setSimulcastInMediaSection(section, trackIdsToAttributes) {
  ...
  // Recreate the media section and make sure that any empty line is
  // moved to the end (We take advantage of the fact that Set items are stored
  // in order of addition). Without the empty line, Chrome rejects the SDP.
