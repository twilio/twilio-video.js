...
/**
 * Get the {@link TwilioError} constructor for a given code and message.
 * @param {number} code - Error code
 * @param {string} message - Error message
 * @returns {TwilioError}
 */
exports.getTwilioError = function getTwilioError(code, message) {
  code = typeof code === 'number' ? code : 0;
  message = (typeof message === 'string' && !!message) ? message : 'Unknown error';
  return TwilioErrorByCode[code] || TwilioError.bind(null, code, message);
};
