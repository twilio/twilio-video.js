...
// Browser detection to check for whether or not the browser is Chrome iOS.
// eslint-disable-next-line no-warning-comments
// TODO(joyce): Move browser detection to a different util
const isAndroid = /android/.test(navigator.userAgent);
const isChromeIOS = guessBrowser() === 'chrome' && isMobile() && !isAndroid;
