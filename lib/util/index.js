 ...
 *   protocol or not.
 * @param {boolean} adaptiveSimulcast - whether to enable the Publisher Hints
 *   protocol or not.
 * @param {boolean} renderHints - whether to enable the renderHints
 *   protocol or not.
 * @param {boolean} trackSubscriptions - whether to enable the Track Subscriptions
 *   protocol or not.
 * @returns {object}
 */
function createMediaSignalingPayload(dominantSpeaker, networkQuality, trackPriority, trackSwitchOff, adaptiveSimulcast, renderHints, trackSubscriptions) {
