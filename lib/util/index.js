...
/**
 * Create a new {@link PublishedTrack} for the given {@link LocalTrack} or
 * MediaStreamTrack.
 * @param {LocalTrack|MediaStreamTrack} track
 * @param {string} sid
 * @param {function(track: PublishedTrack): void} unpublish
 * @param {object} options
 */
function asPublishedTrack(track, sid, unpublish, options) {
  var PublishedTrack = track.kind === 'audio'
    ? options.PublishedAudioTrack
    : options.PublishedVideoTrack;
  return new PublishedTrack(sid, track.id, unpublish, options);
}
...
module.exports.asPublishedTrack = asPublishedTrack;
