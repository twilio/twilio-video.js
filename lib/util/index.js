...
function createRoomConnectEventPayload(connectOptions) {
  ...
  if (connectOptions.bandwidthProfile && connectOptions.bandwidthProfile.video) {
    ...
    ['mode', ['maxSwitchedOnTracks', 'maxVideoTracks'], 'trackSwitchOffMode', 'dominantSpeakerPriority', 'maxSubscriptionBitrate', 'renderDimensions', 'contentPreferencesMode', 'clientTrackSwitchOffControl'].forEach(prop => {
