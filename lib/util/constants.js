...
module.exports.twilioErrors = Array.prototype.reduce.call([
  ...
  { name: 'ROOM_INVITE_FAILED', message: 'Failed to add Participant to Room' },
  { name: 'ROOM_INVITE_TIMEOUT', message: 'Invite to Participant timed out' },
  { name: 'ROOM_INVITE_REJECTED', message: 'Invite was rejected by Participant' },
  { name: 'ROOM_INVITE_CANCELED', message: 'Invite to Participant was canceled' },
  { name: 'ROOM_JOIN_FAILED', message: 'Failed to join Room' },
  { name: 'ROOM_JOIN_CANCELED', message: 'Incoming Invite was canceled by the sender' },
