 ...
 * @param {CreateLocalAudioTrackOptions} [options] - Options for requesting a {@link LocalAudioTrack}
...
const NoiseCancellationVendor = {
  /**
   * This plugin can be found at {@link https://github.com/twilio/twilio-krisp-audio-plugin}
   */
  krisp: 'krisp',
};
