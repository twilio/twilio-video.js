 ...
 * var Video = require('twilio-video');
 *
 * // Request the default audio track with custom name
 * Video.createLocalAudioTrack({ name: 'default-audio-track' }).then(function(localTrack) {
 *   console.log(localTrack.name); // 'default-audio-track'
 * });
 */
 ...
 * var Video = require('twilio-video');
 *
 * // Request the default video track with custom name
 * Video.createLocalVideoTrack({ name: 'default-video-track' }).then(function(localTrack) {
 *   console.log(localTrack.name); // 'default-video-track'
 * });
 */
 ...
 * @property {string} [name] - Optional name for the {@link LocalTrack}; if
 *    not specified, then it is set to the {@link LocalTrack}'s ID.
 */
