 ...
 *   {@link LocalAudioTrack}s; setting this attempts to workaround WebKit Bug
 *   208516. When set sdk will attempt to re-acquire audio track when if its ended or muted,
 *   when the app becomes visible after going background, as suggested here:
