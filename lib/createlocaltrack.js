 ...
 *   MediaStreamTrack.
 * @property {boolean} [workaroundWebKitBug1208516=false] - Only valid for
 *   {@link LocalAudioTrack}s; setting this property works around WebKit Bug
 *   208516. This bug causes the audio track to go into ended or muted state
 *   When browser process is back-grounded. When the workaround flag is set to true
 *   (default on Safari), twilio-video will re-acquire the track when browser
 *   gains foreground and when it detects that it was ended.
 */
