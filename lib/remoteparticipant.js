...
class RemoteParticipant extends Participant {
  ...
  _addTrack(remoteTrack, publication) {
    ...
    if (publication) {
      remoteTrack.setSid(publication.trackSid);
      publication.subscribed(remoteTrack);
    }
...
/**
 * A {@link RemoteTrack} was published by the {@link RemoteParticipant}.
