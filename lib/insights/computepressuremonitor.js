...
class ComputePressureMonitor {
  constructor() {
    ...
    this._pressureObserver = typeof globalThis !== 'undefined'
      && typeof globalThis.PressureObserver === 'function'
      ? /** @type {PressureObserverConstructor} */ (globalThis.PressureObserver)
      : null;
  }
