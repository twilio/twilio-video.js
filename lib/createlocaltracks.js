 ...
 *   audio: { name: 'default-audio-track' },
 *   video: { name: 'default-video-track' }
 * }).then(function(localTracks) {
 *   // ['default-audio-track', 'default-video-track']
 *   console.log(localTracks.map(function(localTrack) {
 *     return localTrack.name;
 *   }));
 * });
 */
