...
class TrackSignaling extends EventEmitter {
   ...
   * @returns {this}
   */
  switched(isSwitchedOff) {
    if (this._isSwitchedOff !== isSwitchedOff) {
      this._isSwitchedOff = isSwitchedOff;
      this.emit(isSwitchedOff ? 'trackswitchedoff' : 'trackswitchedon');
    }
    return this;
  }
}
 ...
 */
 ...
 /**
 * Emitted whenever track is switched off
 * @event TrackSignaling#trackswitchedoff
 */

 /**
 * Emitted whenever track is switched on
 * @event TrackSignaling#trackswitchedon
 */
