 ...
 * @param {?(string|Room.SID)} labelOrSid
 * @param {LocalMedia} localMedia
 * @param {?object} [options={}]
 * @property {?Room.SID} roomSid
 * @property {?string} label
 * @property {?(string|Room.SID)} labelOrSid
...
/**
 * Get the {@link RoomSignaling}.
 * @returns {Promise<RoomSignaling>}
 */
OutgoingInviteSignaling.prototype.getRoomSignaling = function getRoomSignaling() {
