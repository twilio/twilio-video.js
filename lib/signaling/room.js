...
class RoomSignaling extends StateMachine {
  ...
  constructor(localParticipant, sid, name, options) {
    ...
    // during network tests we see that it sometimes take longer than 30 seconds
    // for the signaling websocket to open. this temporary workaround helps make them pass.
    const timeOutMS = options.sessionTimeout * 2;
