    ...
    function createDialog() {
      setTimeout(function setAccepted() {
        if(self._setAccepted()) {
          var dialog = new SIPJSDialog(self.userAgent, self.from, self.conversationSid, self.callSid, localMedia, remoteMedia, peerConnection, self.session, null, self.participantSid);
