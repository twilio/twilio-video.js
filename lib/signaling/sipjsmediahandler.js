...
function SIPJSMediaHandler(session, options) {
  ...
  var iceGatheringTimeout = config.iceCheckingTimeout;
  var localMedia = null;
...
SIPJSMediaHandler.prototype._createPeerConnection = function _createPeerConnection() {
  var self = this;

  var stunServers = this._stunServers;
  var turnServers = this._turnServers;
  var servers = [];
...
SIPJSMediaHandler.prototype.updateIceServers = function updateIceServers(servers) {
  ...
  this._stunServers = servers.stunServers;
  this._turnServers = servers.turnServers;
};
