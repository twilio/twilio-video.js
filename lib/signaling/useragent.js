 ...
 * @memberof Twilio.Signal.Signaling
...
/**
 * Invites another {@link Participant} by address.
 * @instance
 * @param {string} address - the address of a {@link Participant} to invite
...
UserAgent.prototype.invite = function invite(address, options) {
  ...
  var from = this;
  var to = address;
  var inviteClientTransaction = new this._inviteClientTransactionFactory(from, to, options);
