...
UserAgent.prototype.invite = function invite(address, options) {
  ...
  options = util.withDefaults(options, {
    ...
    callTimeout: options.callTimeout || this.callTimeout
  });
...
UserAgent.prototype._onInviteSuccess = function _onInviteSuccess(ict, timeout, dialog) {
  this.inviteClientTransactions.delete(ict);
  clearTimeout(timeout);
  return this._dialogCreated(dialog);
};

UserAgent.prototype._onInviteFailure = function _onInviteFailure(ict, timeout, error) {
  this.inviteClientTransactions.delete(ict);
  clearTimeout(timeout);
  throw error;
};
