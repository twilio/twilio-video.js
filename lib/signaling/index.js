...
// NOTE(mroberts): This is a dummy implementation suitable for testing.
Signaling.prototype._connect = function _connect(conversationSid, localMedia,
  options) {
  void options;
  conversationSid = conversationSid || 'CV00000000000000000000000000000000';
  var participantSid = 'PA00000000000000000000000000000000';
  return new ConversationImpl(localMedia, participantSid, conversationSid,
    this);
};
 ...
 */
Signaling.prototype.connect = function connect(conversationSid, localMedia,
  options) {
  var self = this;
  return this.bracket('connect', function transition(key) {
    switch (self.state) {
      ...
      case 'listening':
        ...
        return self._connect(conversationSid, localMedia, options);
      default:
        throw new Error('Unexpected Signaling state "' + self.state + '"');
    }
  });
