 ...
 */
function SIPJSDialog(userAgent, from, to, sid, localStream, remoteStream, session) {
  if (!(this instanceof SIPJSDialog)) {
    return new SIPJSDialog(userAgent, from, to, sid, localStream, remoteStream, session);
  }
  var self = this;
  Dialog.call(this, userAgent, from, to, sid, localStream, remoteStream);
