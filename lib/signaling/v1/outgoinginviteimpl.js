...
function OutgoingInviteImpl(userAgent, participants, localMedia, options) {
  if (!(this instanceof OutgoingInviteImpl)) {
    return new OutgoingInviteImpl(userAgent, participants, localMedia, options);
  }
  ...
  OutgoingInviteImpl_.call(this, participants, null, localMedia, options);
  ...
  function setupConversation(dialog) {
    ...
    var conversation = self._conversation  || new ConversationImpl(localMedia, participantSid, sid, options);
