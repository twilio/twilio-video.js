...
var OutgoingInviteImpl_ = require('../outgoinginviteimpl');
var TimeoutPromise = require('../../util/timeoutpromise');
var util = require('../../util');

function OutgoingInviteImpl(userAgent, participants, signaling, localMedia,
  options) {
  if (!(this instanceof OutgoingInviteImpl)) {
    return new OutgoingInviteImpl(userAgent, participants, signaling,
      localMedia, options);
  }
  ...
  OutgoingInviteImpl_.call(this, participants, null, localMedia, signaling,
    options);
  ...
  // OutgoingInvite.
  cancelablePromise.catch(function cancelablePromiseRejected(reason) {
  ...
  function setupConversation(dialog) {
    ...
    var conversation = self._conversation  || new ConversationImpl(localMedia,
      participantSid, sid, self._signaling, options);
...
inherits(OutgoingInviteImpl, OutgoingInviteImpl_);

OutgoingInviteImpl.prototype._onInviteServerTransaction = function _onInviteServerTransaction(inviteServerTransaction) {
