...
function IncomingInviteImpl(inviteServerTransaction, signaling, options) {
  if (!(this instanceof IncomingInviteImpl)) {
    return new IncomingInviteImpl(inviteServerTransaction, signaling, options);
  }
  ...
  IncomingInviteImpl_.call(this, conversationSid, from, participantSid,
    signaling);
...
IncomingInviteImpl.prototype._onDialog = function _onDialog(dialog) {
  ...
  var conversation
    = this._conversation
    = this._conversation || new ConversationImpl(this._localMedia,
        this.participantSid, this.conversationSid, this._signaling,
        this._options);
...
IncomingInviteImpl.prototype._accept = function accept(localMedia, options) {
  ...
  this._localMedia = options.localMedia = localMedia;
