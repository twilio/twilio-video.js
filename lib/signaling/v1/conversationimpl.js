...
function ConversationImpl(localMedia, participantSid, sid, options) {
  if (!(this instanceof ConversationImpl)) {
    return new ConversationImpl(localMedia, participantSid, sid, options);
  }
  ...
  ConversationImpl_.call(this, localMedia, participantSid, sid, options);
