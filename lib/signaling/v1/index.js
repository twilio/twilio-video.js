...
var IncomingInviteImpl = require('./incominginviteimpl');
...
SignalingV1.prototype._onInviteServerTransaction =
  ...
  var incomingInvite = new IncomingInviteImpl(inviteServerTransaction, this._options);
...
SignalingV1.prototype.connect = function connect(identities, conversationSid,
  ...
  var outgoingInvite = new OutgoingInviteImpl(this._userAgent, identities, localMedia, options);
...
function handleAccessManagerEvents(signaling, accessManager) {
  accessManager.on('tokenUpdated', function onTokenUpdated() {
    signaling._userAgent._register();
  });
}
