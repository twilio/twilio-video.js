...
function Dialog(userAgent, remote, conversationSid, callSid, localMedia, remoteMedia, peerConnection) {
  ...
  function handleTrack(wasAdded, track) {
    ...
    if (self.ended) {
      localMedia.removeListener('trackAdded', this);
      localMedia.removeListener('trackRemoved', this);
      return;
    }
  ...
  localMedia.on('trackAdded', handleTrack.bind(null, true));
  localMedia.on('trackRemoved', handleTrack.bind(null, false));
