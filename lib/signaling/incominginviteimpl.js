 ...
 */
function IncomingInviteImpl(conversationSid, from, participantSid, options) {
...
IncomingInviteImpl.prototype._accept = function _accept(localMedia, options,
  ...
  return new ConversationImpl(localMedia, this.participantSid, this.conversationSid, options);
};
