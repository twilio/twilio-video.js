...
class ParticipantSignaling extends StateMachine {
  ...
  setNetworkQualityLevel(networkQualityLevel, networkQualityLevels) {
    // we should send update if level has changed or stats are added/removed.
    const shouldSendUpdate = (this._networkQualityLevel !== networkQualityLevel) ||
      ((this._networkQualityStats === null) !== (networkQualityLevels === null)) ||
      (this._networkQualityStats && Object.keys(this._networkQualityStats) !== Object.keys(networkQualityLevels));
