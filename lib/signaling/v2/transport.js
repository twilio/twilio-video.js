...
const TwilioErrors = require('../../util/twilio-video-errors');
const createTwilioError = TwilioErrors.createTwilioError;
const SignalingConnectionError = TwilioErrors.SignalingConnectionError;
const SignalingConnectionTimeoutError = TwilioErrors.SignalingConnectionTimeoutError;
const SignalingIncomingMessageInvalidError = TwilioErrors.SignalingIncomingMessageInvalidError;
...
class Transport extends StateMachine {
  constructor(name, accessToken, localParticipant, peerConnectionManager, ua, options) {
    ...
    const session = createSession(this, name, accessToken, localParticipant, peerConnectionManager, ua, options.SIPJSMediaHandler);
