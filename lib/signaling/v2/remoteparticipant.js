...
class RemoteParticipantV2 extends RemoteParticipantSignaling {
   ...
   * @param {function(string, renderHint): void} setRenderHint
   *
   * @param {object} [options]
   */
  constructor(participantState, getTrackReceiver, getInitialTrackSwitchOffState, setRenderHint, options) {
  ...
  updateTrackRenderHint(trackSid, renderHint) {
    this._setRenderHint(trackSid, renderHint);
  }
