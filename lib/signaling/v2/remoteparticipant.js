 ...
 * @param {function(string): Promise<MediaStreamTrack|RemoteDataStreamTrack>} getMediaOrDataStreamTrack
 * @param {object} [options]
 * @property {?number} revision
 */
function RemoteParticipantV2(participantState, getMediaOrDataStreamTrack, options) {
  if (!(this instanceof RemoteParticipantV2)) {
    return new RemoteParticipantV2(participantState, getMediaOrDataStreamTrack, options);
  }
  ...
  Object.defineProperties(this, {
    ...
    _getMediaOrDataStreamTrack: {
      value: getMediaOrDataStreamTrack
    },
    revision: {
      enumerable: true,
      get: function() {
...
RemoteParticipantV2.prototype.addTrack = function addTrack(track) {
  ...
  this._getMediaOrDataStreamTrack(track.id).then(function(mediaOrDataStreamTrack) {
    track.setMediaOrDataStreamTrack(mediaOrDataStreamTrack);
  });
