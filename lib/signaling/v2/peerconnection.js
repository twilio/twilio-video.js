...
class PeerConnectionV2 extends StateMachine {
  ...
  constructor(id, encodingParameters, preferredCodecs, options) {
    ...
    peerConnection.onconnectionstatechange = this._handleConnectionStateChange.bind(this);
    peerConnection.ondatachannel = this._handleDataChannelEvent.bind(this);
    peerConnection.onicecandidate = this._handleIceCandidateEvent.bind(this);
    peerConnection.oniceconnectionstatechange = this._handleIceConnectionStateChange.bind(this);
    peerConnection.onicegatheringstatechange = this._handleIceGatheringStateChange.bind(this);
    peerConnection.onsignalingstatechange = this._handleSignalingStateChange.bind(this);
    peerConnection.ontrack = this._handleTrackEvent.bind(this);
  ...
  _setRemoteDescription(description) {
    ...
    return Promise.resolve().then(() => {
      ...
      this._peerConnection.setRemoteDescription(description, resolve, reject);
    })).then(() => {
