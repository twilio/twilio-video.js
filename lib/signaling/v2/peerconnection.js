...
function updateDtlsTransport(pcv2) {
  ...
  if (transport && transport !== pcv2._dtlsTransport) {
    if (pcv2._dtlsTransport) {
      pcv2._dtlsTransport.removeEventListener('statechange', pcv2._handleDtlsTransportStateChange);
    }
