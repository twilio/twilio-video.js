...
class PeerConnectionV2 extends StateMachine {
  ...
  constructor(id, encodingParameters, preferredCodecs, options) {
    ...
    Object.defineProperties(this, {
      ...
      _screenShareEncodingPriority: {
        value: options.screenShareEncodingPriority
      },
      _singleScreenShareActiveLayer: {
        value: options.singleScreenShareActiveLayer
      },
      id: {
        enumerable: true,
        value: id
  ...
  _updateEncodings(track, encodings, trackReplaced) {
    if (this._isChromeScreenShareTrack(track)) {
      const screenShareActiveLayerConfig = [{
        priority: this._screenShareEncodingPriority,
        scaleResolutionDownBy: 1
      }];
      if (!this._singleScreenShareActiveLayer) {
        screenShareActiveLayerConfig.push({ scaleResolutionDownBy: 1 });
      }
      encodings.forEach((encoding, i) => {
        const activeLayerConfig = screenShareActiveLayerConfig[i];
        if (activeLayerConfig) {
          encoding.priority = activeLayerConfig.priority || encoding.priority;
