...
PeerConnectionV2.prototype._answer = function _answer(offer) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var _reject = rejectWithTwilioError(reject, 'MEDIA_CLIENT_REMOTE_DESC_FAILED');
    ...
    return new Promise(function(resolve, reject) {
      var _reject = rejectWithTwilioError(reject, 'MEDIA_CLIENT_LOCAL_DESC_FAILED');
...
function rejectWithTwilioError(reject, errorName) {
  return function(error) {
    reject(new TwE[errorName](error.message));
  };
}
