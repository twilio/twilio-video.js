...
class PeerConnectionV2 extends StateMachine {
  ...
  _handleIceGatheringStateChange() {
    ...
    if (iceGatheringState === 'gathering' && !this._didGenerateLocalCandidates && !this._iceGatheringTimeout.isSet) {
      log.debug(`Starting ICE gathering timeout: ${DEFAULT_ICE_GATHERING_TIMEOUT_MS}`);
