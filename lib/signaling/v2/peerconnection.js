...
class PeerConnectionV2 extends StateMachine {
  ...
  get isApplicationSectionNegotiated() {
    // NOTE(mmalavalli): Because of VIDEO-1981, we only avoid re-negotiations
    // for LocalDataTrack changes when the remote peer is an SFU.
    // TODO(mmalavalli): Remove the ICE-lite agent check once VIDEO-1981
    // is fixed.
    return this._isIceLite && this._peerConnection.localDescription
