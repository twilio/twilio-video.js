...
/**
 * Add a {@link LocalTrackPublicationV2} for the given MediaStreamTrack to the
 * {@link LocalParticipantV2}.
 * @param {MediaStreamTrack} mediaStreamTrack
 * @returns {this}
 */
LocalParticipantV2.prototype.addTrack = function addTrack(mediaStreamTrack) {
  var localTrackPublicationV2 = new this._LocalTrackPublicationV2(mediaStreamTrack);
...
/**
 * Remove the {@link LocalTrackPublicationV2} for the given MediaStreamTrack
 * from the {@link LocalParticipantV2}.
 * @param {MediaStreamTrack} mediaStreamTrack
 * @returns {boolean}
 */
LocalParticipantV2.prototype.removeTrack = function removeTrack(mediaStreamTrack) {
  var localTrackPublicationV2 = this.tracks.get(mediaStreamTrack.id);
  if (!localTrackPublicationV2) {
    return false;
  }
