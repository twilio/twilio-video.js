 ...
 * @emits LocalParticipantV2#networkQualityConfigurationUpdated
 */
class LocalParticipantV2 extends ParticipantSignaling {
   ...
   * @returns {void}
   */
  setNetworkQualityConfiguration(config) {
    this._networkQualityConfiguration = config;
    this.emit('networkQualityConfigurationUpdated');
  }
}
