 ...
 */
function LocalTrackPublicationV2(mediaOrDataStreamTrack) {
  if (!(this instanceof LocalTrackPublicationV2)) {
    return new LocalTrackPublicationV2(mediaOrDataStreamTrack);
  }
  LocalTrackPublicationSignaling.call(this, mediaOrDataStreamTrack);
}
