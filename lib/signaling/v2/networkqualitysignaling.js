  ...
  _sendNetworkQualityInputs() {
    return this._networkQualityInputs.take().then(networkQualityInputs => {
      this._mediaSignalingTransport.publish(
        createNetworkQualityInputsMessage(networkQualityInputs, this._networkQualityConfiguration));
    });
  }
 ...
 */
function createNetworkQualityInputsMessage(networkQualityInputs, networkQualityConfiguration) {
