...
/**
 * Re-emit any ICE candidate events on an RTCPeerConnection as Conversation
 * Info. Returns a function that, when called, disables this behavior.
 * @private
 * @param {string} id
...
PeerConnectionManager.prototype._onicecandidate = function _onicecandidate(id, peerConnection) {
  ...
  function onicecandidate(event) {
    ...
    self.queue('conversationInfo', conversationInfo);
  }
