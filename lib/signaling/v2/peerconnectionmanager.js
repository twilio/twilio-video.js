...
PeerConnectionManager.prototype.setTrackSenders = function setTrackSenders(trackSenders) {
  var dataTrackSenders = new Set(trackSenders.filter(trackSender => trackSender.kind === 'data'));
  var mediaTrackSenders = new Set(trackSenders.filter(trackSender => trackSender.kind === 'audio' || trackSender.kind === 'video'));
