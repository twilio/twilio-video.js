...
class TwilioConnectionTransport extends StateMachine {
  ...
  _createConnectOrSyncOrDisconnectMessage() {
    ...
    if (message.type === 'connect') {
      ...
      // TODO(mmalavalli): For the POC, we enable the track_subscriptions MSP
      // by default. Add a ConnectOptions flag for this MSP later, if needed.
      const trackSubscriptions = true;
