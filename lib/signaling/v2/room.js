...
function RoomV2(localMedia, participantSid, roomSid, session, options) {
  if (!(this instanceof RoomV2)) {
    return new RoomV2(localMedia, participantSid, roomSid, session, options);
  }
  RoomSignaling.call(this, localMedia, participantSid, roomSid, options);
...
function handleLocalMediaEvents(roomV2, localMedia) {
