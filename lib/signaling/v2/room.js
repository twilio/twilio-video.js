...
/**
 * Collect room stats periodically for processing
 * @private
 * @param {RoomV2} roomV2
 */
function periodicallyCollectStats(roomV2) {
  const interval = setInterval(async () => {
    try {
      ...
      roomV2._log.debug('Error collecting room stats periodically:', error);
    }
