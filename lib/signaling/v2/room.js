...
class RoomV2 extends RoomSignaling {
  constructor(localParticipant, initialState, transport, peerConnectionManager, options) {
    ...
    Object.defineProperties(this, {
      ...
      _trackPriorityMSP: {
        value: new MediaSignaling(getTrackReceiver, 'track_priority', { log })
      },
      _trackSwitchOffMSP: {
        value: new MediaSignaling(getTrackReceiver, 'track_switch_off', { log })
      },
      _dominantSpeakerMSP: {
        value: new MediaSignaling(getTrackReceiver, 'active_speaker', { log })
      },
      _networkQualityMSP: {
        value: new MediaSignaling(getTrackReceiver, 'network_quality', { log })
      },
  ...
  _update(roomState) {
    ...
    [this._dominantSpeakerMSP, this._networkQualityMSP, this._trackPriorityMSP, this._trackSwitchOffMSP].forEach(mediaSignaling => {
