...
class RoomV2 extends RoomSignaling {
  ...
  _setNetworkQualityMonitor(networkQualityMonitor) {
    ...
    networkQualityMonitor.on('updated', levels => this.localParticipant.setNetworkQualityLevels(levels));
...
function handlePeerConnectionEvents(roomV2, peerConnectionManager) {
  ...
  peerConnectionManager.on('iceConnectionStateChanged', () => roomV2.emit('mediaConnectionStateChanged'));
}
