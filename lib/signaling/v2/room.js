...
const LiveTranscriptionSignaling = require('./livetranscriptionsignaling');
...
class RoomV2 extends RoomSignaling {
  constructor(localParticipant, initialState, transport, peerConnectionManager, options) {
    ...
    Object.defineProperties(this, {
      ...
      _liveTranscriptionSignaling: {
        value: new options.LiveTranscriptionSignaling(getTrackReceiver, { log })
      },
    ...
    this._initLiveTranscriptionSignaling();
  ...
  _initLiveTranscriptionSignaling() {
    this._liveTranscriptionSignaling.on('transcription', data => {
      this.emit('liveTranscription', data);
    });
  }
