...
function replaceNullsWithDefaults(activeIceCandidatePair, peerConnectionId) {
  ...
  activeIceCandidatePair.localCandidate = Object.assign({
    ...
    protocol: 'udp',
    url: ''
  }, filterObject(activeIceCandidatePair.localCandidate || {}, null), (activeIceCandidatePair.localCandidate && activeIceCandidatePair.localCandidate.relayProtocol && { relayProtocol: 'udp' }));
