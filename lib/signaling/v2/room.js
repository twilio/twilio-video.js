...
class RoomV2 extends RoomSignaling {
  constructor(localParticipant, initialState, transport, peerConnectionManager, options) {
    ...
    Object.defineProperties(this, {
      ...
      _trackPriorityMSP: {
        value: new MSPTransportHandler(getTrackReceiver, 'track_priority', { log })
      },
      _trackSwitchOffMSP: {
        value: new MSPTransportHandler(getTrackReceiver, 'track_switch_off', { log })
      },
      _dominantSpeakerMSP: {
        value: new MSPTransportHandler(getTrackReceiver, 'active_speaker', { log })
      },
      _networkQualityMSP: {
        value: new MSPTransportHandler(getTrackReceiver, 'network_quality', { log })
      },
  ...
  _update(roomState) {
    ...
    [this._dominantSpeakerMSP, this._networkQualityMSP, this._trackPriorityMSP, this._trackSwitchOffMSP].forEach(mspObject => {
