 ...
 * @class
 * @classdesc A {@link Stream} wraps a MediaStream object (either from
 ...
 *   HTML &lt;video&gt; elements.
 *   <br><br>
 *   You should not call {@link Stream}'s constructor directly; most methods,
 *   such as {@link Endpoint#createConversation}, will construct a
 *   {@link Stream} when necessary.
 *   <br><br>
 *   If you want to get access to a
 *   {@link Stream} before participating in a {@link Conversation} (for
 *   example, to preview your video), you should call
 *   {@link Stream.getUserMedia}.
...
Stream.prototype.clone = function clone() {
  var clonedStream = new Stream(this.mediaStream.clone());
  clonedStream._local = this._local;
  return clonedStream;
};
...
Stream.prototype.combine = function combine(stream) {
  ...
  var mediaStream;
  if (typeof webkitMediaStream !== 'undefined') {
    // Make JSHint happy when we call `webkitMediaStream` using `new`.
    MediaStream = webkitMediaStream;
    mediaStream = new MediaStream();
  } else if (typeof mozMediaStream !== 'undefined') {
    MediaStream = mozMediaStream;
    mediaStream = new MediaStream();
  } else {
