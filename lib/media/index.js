...
Media.prototype._addTrack = function _addTrack(track) {
  ...
  var log = this._log;
  var trackClass = { audio: 'AudioTrack', video: 'VideoTrack' };
  log.info('Added ' + trackClass[track.kind] + ':', track.id);
...
Media.prototype._removeTrack = function _removeTrack(track) {
  ...
  var log = this._log;
  var trackClass = { audio: 'AudioTrack', video: 'VideoTrack' };
  log.info('Removed a ' + trackClass[track.kind] + ':', track.id);
