...
class RemoteVideoTrack extends RemoteMediaVideoTrack {
  ...
  constructor(sid, mediaTrackReceiver, isEnabled, isSwitchedOff, setPriority, setRenderHint, options) {
    options = Object.assign({
      ...
      IntersectionObserver: typeof IntersectionObserver === 'undefined' || !options.idleTrackSwitchOff  ? NullObserver : IntersectionObserver,
      ResizeObserver: typeof ResizeObserver === 'undefined' || !options.renderHints ?  NullObserver : ResizeObserver,
    }, options);
