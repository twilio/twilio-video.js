...
class RemoteVideoTrack extends RemoteMediaVideoTrack {
  ...
  constructor(sid, mediaTrackReceiver, isEnabled, isSwitchedOff, switchOffReason, setPriority, setRenderHint, options) {
    ...
    super('video', sid, mediaTrackReceiver, isEnabled, isSwitchedOff, switchOffReason, setPriority, setRenderHint, options);
  ...
  _setMediaTrackReceiver(mediaTrackReceiver) {
    ...
    super._setMediaTrackReceiver(mediaTrackReceiver);
    if (processor) {
