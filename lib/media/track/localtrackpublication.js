  ...
  constructor(signaling, track, unpublish, options) {
    ...
    Object.defineProperties(this, {
      _reemitSignalingEvent: {
        value: (name, args) => this.emit(name, ...args)
      },
      _reemitTrackEvent: {
    ...
    ['warning', 'warningsCleared'].forEach(name =>
      signaling.on(name, (...args) => this._reemitSignalingEvent(name, args)));
...
/**
 * The published {@link LocalTrack} encountered a {@link TwilioWarning}.
 * @event LocalTrackPublication#warning
 * @param {TwilioWarning} name - The {@link TwilioWarning} that was raised.
 */

/**
 * The published {@link LocalTrack} cleared all {@link TwilioWarning}s.
