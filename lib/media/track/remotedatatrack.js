...
class RemoteDataTrack extends Track {
   ...
   * @property {Track.SID}
   * @deprecated Use the parent {@link RemoteTrackPublication}'s .trackSid
   *   instead
   */
  get sid() {
    this._log.deprecated('RemoteDataTrack#sid has been deprecated and is '
      + 'scheduled for removal in twilio-video.js@2.0.0. Use the '
      + 'parent RemoteTrackPublication\'s .trackSid instead.');
    return this._sid;
  }
