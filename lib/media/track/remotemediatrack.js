...
function mixinRemoteMediaTrack(AudioOrVideoTrack) {
  ...
  return class RemoteMediaTrack extends AudioOrVideoTrack {
    ...
    /**
     * TODO: this is exposed temporarily for testing.
     * Notifies server(SFU) asynchronously about dimension and visible state of the {@link RemoteMediaTrack}.
     * @param {ClientRenderHint} renderHint - object specifying the new {@link ClientRenderHint}
     */
    setRenderHint(hint) {
      this._setRenderHint(hint);
    }
