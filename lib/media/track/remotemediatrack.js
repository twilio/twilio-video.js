  ...
  return class RemoteMediaTrack extends AudioOrVideoTrack {
    ...
    constructor(sid, mediaTrackReceiver, isEnabled, options) {
      ...
      Object.defineProperties(this, {
        ...
        _onPriorityChange: {
          value: options.onPriorityChange
        },
        isEnabled: {
          enumerable: true,
          get() {
    ...
    /**
     * Update the {@link Track.Priority} of the subscribed {@link LocalTrack}.
     * @param {Track.Priority} ?priority - the new {@link Track.priority}.
     *   if set to `null` the subscriber priority is reset, thus making publisher Priority effective.
     * @returns {this}
     * @throws {RangeError}
     */
    setPriority(priority) {
      ...
      if (this._priority !== priority) {
        ...
        this._onPriorityChange(this.sid, priority);
      }
    }
