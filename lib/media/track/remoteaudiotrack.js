 ...
 * @extends AudioTrack
 * @property {boolean} isInterrupted - Whether the {@link RemoteAudioTrack} is interrupted
 * @property {Track.SID} sid - The {@link RemoteAudioTrack}'s SID
 * @emits RemoteAudioTrack#disabled
 * @emits RemoteAudioTrack#enabled
 * @emits RemoteAudioTrack#interrupted
 * @emits RemoteAudioTrack#resumed
...
/**
 * A {@link RemoteAudioTrack} was interrupted.
 * @event RemoteAudioTrack#interrupted
 */

/**
 * A {@link RemoteAudioTrack} was resumed.
 * @event RemoteAudioTrack#resumed
 */
