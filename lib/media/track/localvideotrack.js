...
var TrackSignaling = require('../../signaling/track');
...
function LocalVideoTrack(mediaStream, mediaStreamTrack) {
  ...
  var trackSignaling = new TrackSignaling(mediaStreamTrack.id, mediaStreamTrack.kind, mediaStreamTrack.enabled ? 'enabled' : 'disabled');
  VideoTrack.call(this, mediaStream, mediaStreamTrack, trackSignaling);
  LocalTrack.call(this);
}
