...
class LocalVideoTrack extends LocalMediaVideoTrack {
  ...
  /**
   * Disable the {@link LocalVideoTrack} and the `processedTrack` if present.
  ...
  /**
   * Enable the {@link LocalVideoTrack} and the `processedTrack` if present.
   * This is effectively "unpause".
   * @returns {this}
