...
class LocalVideoTrack extends LocalMediaVideoTrack {
  ...
  /**
   * Disable the {@link LocalVideoTrack}. If a {@link VideoProcessor}
   * is added, then <code>processedTrack</code> is disabled as well.
   * @returns {this}
  ...
  /**
   * Enable the {@link LocalVideoTrack}. If a {@link VideoProcessor}
   * is added, then <code>processedTrack</code> is enabled as well.
   * @returns {this}
   * @fires VideoTrack#enabled
  *//**
   * Enable or disable the {@link LocalVideoTrack}. If a {@link VideoProcessor}
   * is added, then <code>processedTrack</code> is enabled or disabled as well.
...
/**
 * The {@link LocalVideoTrack} was disabled.
...
/**
 * The {@link LocalVideoTrack} was enabled.
 ...
 * back to the application, especially on mobile devices.
