...
class RemoteTrackPublication extends TrackPublication {
  ...
  constructor(signaling, options) {
    ...
    signaling.on('trackSwitchedOff', (switchedOff) => {
      if (this.track) {
        this.track._setSwitchedOff(switchedOff);
      }
    });
  }
 ...
 */
 ...
 /**
 * The {@link RemoteTrack} was switched on or off.
 * @param {boolean} switchedOff - true if the {@link RemoteTrack} that was switched off else false.
