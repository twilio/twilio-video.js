...
class RemoteTrackPublication extends TrackPublication {
  ...
  constructor(signaling, options) {
    ...
    signaling.on('updated', () => {
      ...
      if (trackTransceiver !== signaling.trackTransceiver && signaling.kind === 'video') {
        // eslint-disable-next-line no-console
        console.log(`Changing MIDs for ${signaling.sid}: ${trackTransceiver ? trackTransceiver.mid : null} => ${signaling.trackTransceiver.mid}`);
        trackTransceiver = signaling.trackTransceiver;
        if (this.track && trackTransceiver) {
