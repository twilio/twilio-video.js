...
/**
 * A {@link NoiseCancellation} allows you to control enable/disable noise cancellation at runtime.
 ...
 * @typedef {object} NoiseCancellation
 * @property {NoiseCancellationVendor} vendor - identifies the noise cancellation library vendor.
 * @property {function} enable - enables noise cancellation.
 * @property {function} disable - disables noise cancellation.
 * @property {MediaStreamTrack} sourceTrack - This is underlying AudioTrack obtained from GetUserMedia.
 * @property {boolean} isEnabled - true if currently noise cancellation is enabled.
 *
 * @example
 * const { connect, createLocalAudioTrack } = require('twilio-video');
 *
