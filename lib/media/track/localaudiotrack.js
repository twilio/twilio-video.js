  ...
  *//**
  ...
  _maybeProcessTrack(track) {
    if (this.options.processor) {
      this._log.info('Processing track: ', track);
      return this.options.processor.process(track).then(processedTrack => {
        this._log.info('done Processing track: ', processedTrack);
        return processedTrack;
      }).catch(er => {
        this._log.error('Error  Processing track: ', er);
        return track;
      });
    }
    return track;
