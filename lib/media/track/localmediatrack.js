...
function restartWhenInadvertentlyStopped(localMediaTrack) {
  ...
  function shouldReacquireTrack() {
    ...
    console.log(`makarand:shouldReacquireTrack:<Local${kind}:${instanceId}> muted=${muted}, document.visibilityState=${document.visibilityState}, isInadvertentlyStopped=${isInadvertentlyStopped}`);
