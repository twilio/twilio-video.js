  ...
  return class LocalMediaTrack extends AudioOrVideoTrack {
    ...
    constructor(mediaStreamTrack, options) {
      ...
      Object.defineProperties(this, {
        ...
        id: {
          enumerable: true,
          value: mediaTrackSender.id // TODO: is it a concern that the id changes for a track (because of track getting replaced?)
        },
        isEnabled: {
          enumerable: true,
          value: mediaTrackSender.enabled
        },
        isStopped: {
          enumerable: true,
          value: mediaTrackSender.isStopped
        }
      });
    }
