...
function mixinLocalMediaTrack(AudioOrVideoTrack) {
  ...
  return class LocalMediaTrack extends AudioOrVideoTrack {
    ...
    constructor(mediaStreamTrack, options) {
      ...
      const { restartOnMuted, restartOnEnded, trackReAcquireCallback } = options;

      const mediaTrackSender = new MediaTrackSender(mediaStreamTrack, { restartOnMuted, restartOnEnded, trackReAcquireCallback });
    ...
    stop() {
      console.log('makarand: LocalMediaTrack.stop');
      this._log.info('Stopping');
      this.mediaStreamTrack.stop();
      this._trackSender.wasStopped();
      this._end();
      return this;
    }
  };
