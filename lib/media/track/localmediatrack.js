...
function restartWhenInadvertentlyStopped(localMediaTrack) {
  ...
  function shouldReacquireTrack() {
    return document.visibilityState === 'visible'
      && (localMediaTrack.mediaStreamTrack.muted || localMediaTrack.isStopped);
  }

  function reacquireTrack() {
    const constraints = { audio: false, video: false };
    constraints[localMediaTrack.mediaStreamTrack.kind] = localMediaTrack.mediaStreamTrack.getConstraints();
