 ...
 *   terminated in the region that you prefer. If you are the first to join a Group Room created with the <code style="padding:0 0">gll</code>
 *   Media Region (either Ad-Hoc or via the REST API), then the Room's Media Region will be selected
 *   based upon your signaling region. Please refer to this <a href="https://www.twilio.com/docs/video/ip-address-whitelisting#signaling-communication" target="_blank">table</a>
