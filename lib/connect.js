...
function connect(token, options) {
  ...
  // Note(mpatwardhan): idleTrackSwitchOff and renderHints options are to be Opt-out
  //  they are enabled by default bandwidth profile is enabled
 ...
 * @property {boolean} [renderHints] - Optional parameter that when enabled allows the media server
 *   to send video with bitrate and dimensions based on the render dimensions of the video
 *   elements attached to {@link RemoteVideoTrack}. This is enabled by default
