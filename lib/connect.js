 ...
 * @property {string} [mediaRegion=gll] - Preferred media region; By default, you will be connected to the
 *   nearest media server determined by latency based routing.
