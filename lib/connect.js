...
const MediaStreamEventPublisher = require('./insights/mediastreameventpublisher');
const { setDefaultMediaStreamEventPublisher } = require('./createlocaltracks');
...
function connect(token, options) {
  ...
  if (options.insights && eventObserver) {
    const mediaStreamEventPublisher = new MediaStreamEventPublisher(eventObserver, log);
