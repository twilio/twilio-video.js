 ...
 * @property {boolean} [networkMonitor=true] - Allows for the network activity to be monitored in order to proactively
 * reconnect when a network change has been detected.
