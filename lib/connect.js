 ...
 * @property {?string} [region='gll'] - Preferred region. This region will be used
 *  to determine signaling server. if not specified, defaults to 'gll', which
 *  auto determines lowest latency region.
