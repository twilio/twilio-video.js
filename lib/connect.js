 ...
 * @property {number} [iceServersTimeout=3000] - <code>(deprecated)</code> unused
...
function createRoomSignaling(token, options, signaling, /* iceServerSource, */ encodingParameters, preferredCodecs, localParticipant) {
  ...
  // makarand: remove `iceServerSource.start()` and move to signaling.
  ...
  // options.iceServers = iceServers; // TODO: set from inside signaling.
