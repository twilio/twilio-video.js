...
function connect(token, options) {
  ...
  const mediaStreamEventPublisher = options.insights && eventObserver
    ? new MediaStreamEventPublisher(eventObserver, log)
    : null;
  options = Object.assign({ eventObserver, wsServer, mediaStreamEventPublisher }, options);
  options.log = log;
