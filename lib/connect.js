...
function connect(token, options) {
  ...
  /* eslint new-cap:0 */
  const wsServer = options._useTwilioConnection
    ? constants.WS_SERVER_TWILIOCONNECTION(options.environment)
    : constants.WS_SERVER(options.environment, options.realm);
...
/**
 * You may pass this object to {@link ConnectOptions} to override
 *   verbosity level for network quality information.
 ...
 * @property {NetworkQualityVerbosity} [remote=0] - Verbosity level for {@link RemoteParticipant}.
 */
