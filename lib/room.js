...
class Room extends EventEmitter {
   ...
   * mobile browsers (Safari and Chrome), where there is a possibility that the muted local media
   * {@link Track}s are never unmuted and inadvertently paused HTMLMediaElements are never played
   * again, especially after handling an incoming phone call.
   * @returns {this}
   */
