...
/**
 * One of the {@link LocalParticipant}'s {@link LocalTrack}s in the {@link Room} encounters a {@link TwilioWarning}.
 * @param {TwilioWarning} name - The {@link TwilioWarning} that was raised.
 * @param {LocalTrack} track - The {@link LocalTrack} that encountered the {@link TwilioWarning}.
 ...
 *     }, 5000);
 *
 *     room.once('trackWarningsCleared', (track, participant) => {
...
/**
 * One of the {@link LocalParticipant}'s {@link LocalTrack}s in the {@link Room} cleared all {@link TwilioWarning}s.
 * @param {LocalTrack} track - The {@link LocalTrack} that cleared all {@link TwilioWarning}s.
 * @param {LocalParticipant} participant - The {@link LocalParticipant}
...
function handleLocalParticipantEvents(room, localParticipant) {
  localParticipant.on('trackWarning', (twilioWarningName, localTrack) => {
    room.emit('trackWarning', twilioWarningName, localTrack, localParticipant);
  });

  localParticipant.on('trackWarningsCleared', localTrack => {
    room.emit('trackWarningsCleared', localTrack, localParticipant);
  });
}
