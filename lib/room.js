...
/**
 * A {@link Track} was added by a {@link RemoteParticipant} in the {@link Room}.
 * @deprecated Use Room#trackSubscribed instead
 * @param {Track} track - The {@link Track} that was added
 * @param {RemoteParticipant} participant - The {@link RemoteParticipant} who
 *   added the {@link Track}
 ...
 *   {@link VideoTrack}'s dimensions changed
 * @event Room#trackDimensionsChanged
 */

/**
 * A {@link Track} was disabled by a {@link RemoteParticipant} in the {@link Room}.
 * @param {Track} track - The {@link Track} that was disabled
 * @param {RemoteParticipant} participant - The {@link RemoteParticipant} who
 *   disabled the {@link Track}
 * @event Room#trackDisabled
 */

/**
 * A {@link Track} was enabled by a {@link RemoteParticipant} in the {@link Room}.
 * @param {Track} track - The {@link Track} that was enabled
 * @param {RemoteParticipant} participant - The {@link RemoteParticipant} who
 *   enabled the {@link Track}
 * @event Room#trackEnabled
 */

/**
 * A {@link Track} was removed by a {@link RemoteParticipant} in the {@link Room}.
 * @param {Track} track - The {@link Track} that was removed
 * @param {RemoteParticipant} participant - The {@link RemoteParticipant} who
 *   removed the {@link Track}
...
/**
 * One of a {@link RemoteParticipant}'s {@link Track}s in the {@link Room} started.
