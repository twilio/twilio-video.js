 ...
 *   {@link Room}, if any
 * @property {boolean} isLiveTranscriptionEnabled - Whether or not live transcription is enabled
 *   in the {@link Room}
...
class Room extends EventEmitter {
  ...
  get isLiveTranscriptionEnabled() {
    return this._signaling._liveTranscriptionSignaling?.isEnabled || false;
  }
...
function handleSignalingEvents(room, signaling) {
  ...
  signaling.on('liveTranscription', data => room.emit('liveTranscription', data));
