  ...
  start(publisherToken, subscriberToken, options) {
    ...
    this.createTracks()
      .then(tracks => {
        ...
        publisherRoom = room;
        console.log('publisher joined:', room.sid);
        return this.joinRoom(subscriberToken, Object.assign(options, { name: room.sid }));
      }).then(room => {
        subscriberRoom = room;
        console.log('subscriber joined:', room.sid);
        ...
        console.log('publisher saw subscriber');
        return this.participantsConnected(subscriberRoom);
      }).then(() => {
        console.log('subscriber saw publisher');
      }).then(() => {
