...
/*
 * Add a {@link Participant} for future lookup.
 * @param {Participant} participant - the {@link Participant}
 * @returns {Participant}
 */
/* Participant._add = function _add(participant) {
  registry.set(participant.address, participant);
  return Participant;
}; */
