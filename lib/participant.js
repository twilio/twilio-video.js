    ...
    audioTracks: {
      ...
      get: function get() {
        log.warn('Participant#audioTracks has been deprecated. '
          + 'Use LocalParticipant#audioTrackPublications or '
    ...
    tracks: {
      ...
      get: function get() {
        log.warn('Participant#tracks has been deprecated. '
          + 'Use LocalParticipant#trackPublications or '
    ...
    videoTracks: {
      ...
      get: function get() {
        log.warn('Participant#videoTracks has been deprecated. '
          + 'Use LocalParticipant#videoTrackPublications or '
 ...
 * @deprecated Use RemoteParticipant#trackSubscribed instead
 ...
 * @deprecated Use RemoteParticipant#trackUnsubscribed instead
