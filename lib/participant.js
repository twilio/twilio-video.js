  ...
  constructor(signaling, options) {
    ...
    Object.defineProperties(this, {
      ...
      networkQualityStats: {
        enumerable: true,
        get() {
          return this._signaling.networkQualityStats;
        }
      },
      sid: {
        enumerable: true,
 ...
 * @param {?NetworkQualityStats} networkQualityStats - Stats based on which
 *   {@link NetworkQualityLevel} is calculated, if any
