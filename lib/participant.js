...
/**
 * {@link NetworkQualityLevels} represents the publish and subscribe qualities
 * of both audio and video over a network connection.
 * @interface NetworkQualityLevels
 * @property {PublishAndSubscribeLevels} audio
 * @property {PublishAndSubscribeLevels} video
 */

/**
 * {@link PublishAndSubscribeLevels} represents the publish and subsribe
 * qualities of a network connection.
 * @interface PublishAndSubscribeLevels
 * @property {NetworkQualityLevel} publish
 * @property {NetworkQualityLevel} subscribe
 */
 ...
 * @property {?number} networkQualityLevel - The minimum of the
 *    {@link Participant}'s {@link NetworkQualityLevels}; null if unknown
 * @property {?NetworkQualityLevels} networkQualityLevels - The
 *    {@link Participant}'s {@link NetworkQualityLevels}; null if unknown
 ...
 * @emits Particiapnt#networkQualityLevelsChanged
...
class Participant extends EventEmitter {
  ...
  constructor(signaling, options) {
    ...
    signaling.on('networkQualityLevelsChanged', () =>
  ...
  get networkQualityLevel() {
    const { networkQualityLevels } = this;
    return networkQualityLevels
      ? Math.min(
          networkQualityLevels.audio.publish,
          networkQualityLevels.audio.subscribe,
          networkQualityLevels.video.publish,
          networkQualityLevels.video.subscribe)
      : null;
  }

  get networkQualityLevels() {
    const { networkQualityLevels } = this._signaling;
    return networkQualityLevels
      ? {
          audio: {
            publish: networkQualityLevels.audio.send,
            subscribe: networkQualityLevels.audio.recv,
          },
          video: {
            publish: networkQualityLevels.video.send,
            subscribe: networkQualityLevels.video.recv,
          }
        }
      : null;
  }
...
/**
 * The {@link Participant}'s {@link NetworkQualityLevels} changed.
 * @param {NetworkQualityLevels} networkQualityLevels - The new
 *   {@link NetworkQualityLevels}
 * @event Participant#networkQualityLevelsChanged
 */
