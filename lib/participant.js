 ...
 * @param {PeerConnection} peerConnection - The PeerConnection between your {@link Twilio.Endpoint} and this {@link Participant} within the context of a {@link Conversation}
 ...
 */
function Participant(address, peerConnection, media) {
  if (!(this instanceof Participant)) {
    return new Participant(address, peerConnection, media);
  }
