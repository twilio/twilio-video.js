...
* [API Docs](//media.twiliocdn.com/sdk/js/video/releases/2.8.0-beta.1/docs)
...
```html
<script src="//media.twiliocdn.com/sdk/js/video/releases/2.8.0-beta.1/twilio-video.min.js"></script>
```
