...
* [API Docs](//media.twiliocdn.com/sdk/js/video/releases/2.0.0-beta6/docs)
...
```html
<script src="//media.twiliocdn.com/sdk/js/video/releases/2.0.0-beta6/twilio-video.min.js"></script>
```
