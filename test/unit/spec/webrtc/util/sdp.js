...
describe('SDP utilities', () => {
  const trackIds = [makeFirefoxStyleTrackId(), makeFirefoxStyleTrackId()];
  ...
  const sdp1 = makeUnifiedPlanSDP(1, trackIds, ssrcs);
  const sdp2 = makeUnifiedPlanSDP(2, trackIds, changedSSRCs);
