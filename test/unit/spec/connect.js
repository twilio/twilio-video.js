...
describe('connect', () => {
  ...
  describe('called with ConnectOptions#bandwidthProfile', () => {
    ...
    [
      ...
      [{ video: { subscribedTrackSwitchOffMode: 'auto', maxTracks: 5 } }, 'which specified both maxTracks and subscribedTrackSwitchOffMode', Error, 'options.bandwidthProfile.video.maxTracks is deprecated. Use options.bandwidthProfile.video.subscribedTrackSwitchOffMode instead.'],
      [{ video: { subscribedTrackSwitchOffMode: 'manual', maxTracks: 5 } }, 'which specified both maxTracks and subscribedTrackSwitchOffMode', Error, 'options.bandwidthProfile.video.maxTracks is deprecated. Use options.bandwidthProfile.video.subscribedTrackSwitchOffMode instead.'],
