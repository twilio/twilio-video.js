...
describe('TwilioConnectionTransport', () => {
  combinations([
    ...
    [true, false], // enableLiveTranscription
    ...
    describe(`constructor, called with
      ...
      .enableLiveTranscription flag ${enableLiveTranscription ? 'enabled' : 'disabled'},
      ...
      const testConnect = (isFirstRSPMessage, iceServersStatus) => {
        ...
        it(`should ${action} a Connect RSP message that
          ...
          ${enableLiveTranscription ? 'contains' : 'does not contain'} the "extension_transcriptions" payload,
