...
var _b = require('./util'), asLocalTrack = _b.asLocalTrack, filterObject = _b.filterObject, isNonArrayObject = _b.isNonArrayObject;
var _c = require('./util/constants'), DEFAULT_ENVIRONMENT = _c.DEFAULT_ENVIRONMENT, DEFAULT_LOGGER_NAME = _c.DEFAULT_LOGGER_NAME, DEFAULT_REALM = _c.DEFAULT_REALM, DEFAULT_REGION = _c.DEFAULT_REGION, WS_SERVER = _c.WS_SERVER, SDK_NAME = _c.SDK_NAME, SDK_VERSION = _c.SDK_VERSION, E = _c.typeErrors;
...
function connect(token, options) {
    ...
    var eventObserver = new EventObserver(eventPublisher, Date.now(), log);
