...
var Participant = /** @class */ (function (_super) {
    ...
    Participant.prototype._handleTrackSignalingEvents = function () {
        ...
        function trackSignalingSubscribed(signaling) {
            var isEnabled = signaling.isEnabled, name = signaling.name, kind = signaling.kind, sid = signaling.sid, trackTransceiver = signaling.trackTransceiver, isSwitchedOff = signaling.isSwitchedOff, _a = signaling.switchOffReason, switchOffReason = _a === void 0 ? null : _a;
            var RemoteTrack = {
