...
var Participant = function (_EventEmitter) {
  ...
  _createClass(Participant, [{
    ...
    value: function _handleTrackSignalingEvents() {
      var log = this._log,
          idleTrackSwitchOff = this._idleTrackSwitchOff;
      ...
      function trackSignalingSubscribed(signaling) {
        ...
        var options = { log: log, name: name, idleTrackSwitchOff: idleTrackSwitchOff };
        ...
        var setRenderHint = function setRenderHint(renderHint) {
          return participantSignaling.updateTrackRenderHint(sid, renderHint);
        };
