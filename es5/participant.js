...
var Participant = function (_EventEmitter) {
  ...
  _createClass(Participant, [{
    ...
    value: function _handleTrackSignalingEvents() {
      var log = this._log,
          subscribedTrackSwitchOffMode = this._subscribedTrackSwitchOffMode,
      ...
      function trackSignalingSubscribed(signaling) {
        ...
        var options = { log: log, name: name, subscribedTrackSwitchOffMode: subscribedTrackSwitchOffMode, contentPreferencesMode: contentPreferencesMode };
