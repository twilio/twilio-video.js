...
var _require3 = require('../../util/browserdetection'),
    isChromeIOS = _require3.isChromeIOS;
  ...
  return function (_AudioOrVideoTrack) {
    ...
    function RemoteMediaTrack(sid, mediaTrackReceiver, isEnabled, isSwitchedOff, setPriority, setRenderHint, options) {
      ...
      options = Object.assign({
        ...
        workaroundWebKitBug212780: guessBrowser() === 'safari' || isChromeIOS() && (typeof document === 'undefined' ? 'undefined' : _typeof(document)) === 'object' && typeof document.addEventListener === 'function' && typeof document.visibilityState === 'string'
      }, options);
