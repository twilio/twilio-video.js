...
var LocalVideoTrack = function (_LocalMediaVideoTrack) {
  ...
  _createClass(LocalVideoTrack, [{
    ...
    value: function _setSenderMediaStreamTrack(useProcessed) {
      ...
      var mediaStreamTrack = useProcessed ? this.processedTrack : this.mediaStreamTrack;
     ...
     * localVideoTrack.addProcessor(new GrayScaleProcessor());
     */
    ...
    value: function restart() {
      ...
      if (processor) {
        promise.then(function () {
          return _this4.addProcessor(processor);
        });
      }
