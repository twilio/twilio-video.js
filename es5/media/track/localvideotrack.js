...
var LocalVideoTrack = function (_LocalMediaVideoTrack) {
  ...
  _createClass(LocalVideoTrack, [{
    ...
    value: function _checkIfCanCaptureFrames() {
      return _get(LocalVideoTrack.prototype.__proto__ || Object.getPrototypeOf(LocalVideoTrack.prototype), '_checkIfCanCaptureFrames', this).call(this, this._trackSender.isPublishing);
    }
