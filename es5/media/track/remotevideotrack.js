...
function maybeUpdateEnabledHint(removeVideoTrack) {
  ...
  var visibleElements = removeVideoTrack._getAllAttachedElements().filter(function (el) {
...
function maybeUpdateDimensionHint(removeVideoTrack) {
  ...
  if (visibleElements.length > 0) {
    var _visibleElements$sort = visibleElements.sort(function (el1, el2) {
      return el2.clientHeight + el2.clientWidth - el1.clientHeight - el1.clientWidth - 1;
    }),
        _visibleElements$sort2 = _slicedToArray(_visibleElements$sort, 1),
        _visibleElements$sort3 = _visibleElements$sort2[0],
        clientHeight = _visibleElements$sort3.clientHeight,
        clientWidth = _visibleElements$sort3.clientWidth;
