...
var RemoteVideoTrack = /** @class */ (function (_super) {
    ...
    RemoteVideoTrack.prototype.attach = function (el) {
        ...
        if (!this._documentPipEnterListener && 'documentPictureInPicture' in globalThis &&
            ...
            this._documentPipEnterListener = function (event) {
                _this._log.debug('document pip entered');
                _this._documentPipWindow = event.window;
            };
...
function ensureDocumentPipVideosPlaying(remoteVideoTrack) {
    ...
    try {
        var pipEls_1 = new WeakSet(remoteVideoTrack._documentPipWindow.document.querySelectorAll('video'));
        remoteVideoTrack._attachments.forEach(function (el) {
