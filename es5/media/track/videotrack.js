...
var VideoTrack = function (_MediaTrack) {
  ...
  _createClass(VideoTrack, [{
    ...
    value: function _captureFrames() {
      ...
      var _mediaStreamTrack$get = this.mediaStreamTrack.getSettings(),
          frameRate = _mediaStreamTrack$get.frameRate;
      ...
      this._dummyEl.play().then(function () {
        ...
        var process = function process() {
          ...
          _this2._inputFrame.getContext('2d').drawImage(_this2._dummyEl, 0, 0, _this2._inputFrame.width, _this2._inputFrame.height);
          ...
          (result instanceof Promise ? result : Promise.resolve(result)).then(function (outputFrame) {
            ...
            if (outputFrame) {
              _this2._outputFrame.getContext('2d').drawImage(outputFrame, 0, 0, _this2._outputFrame.width, _this2._outputFrame.height);
            }
          }).finally(function () {
            return captureFrame(process);
          });
        };
     ...
     *   videoTrack.addProcessor(new GrayScaleProcessor());
     * });
     */
    ...
    value: function addProcessor(processor) {
      ...
      var _mediaStreamTrack$get2 = this.mediaStreamTrack.getSettings(),
          width = _mediaStreamTrack$get2.width,
          height = _mediaStreamTrack$get2.height,
          frameRate = _mediaStreamTrack$get2.frameRate;
