...
var _require5 = require('../../util/browserdetection'),
    isChromeIOS = _require5.isChromeIOS;
...
function mixinLocalMediaTrack(AudioOrVideoTrack) {
  ...
  return function (_AudioOrVideoTrack) {
    ...
    function LocalMediaTrack(mediaStreamTrack, options) {
      ...
      var workaroundWebKitBug1208516 = guessBrowser() === 'safari' || isChromeIOS() && (typeof document === 'undefined' ? 'undefined' : _typeof(document)) === 'object' && typeof document.addEventListener === 'function' && typeof document.visibilityState === 'string';
