...
exports.createLocalTracks = exports.setDefaultMediaStreamEventPublisher = void 0;
...
var defaultMediaStreamEventPublisher = null;
function setDefaultMediaStreamEventPublisher(publisher) {
    defaultMediaStreamEventPublisher = publisher || null;
}
exports.setDefaultMediaStreamEventPublisher = setDefaultMediaStreamEventPublisher;
/**
...
function createLocalTracks(options) {
    return __awaiter(this, void 0, void 0, function () {
        var isAudioVideoAbsent, fullOptions, logComponentName, logLevels, log, localTrackOptions, extraLocalTrackOptions, noiseCancellationOptions, mediaStreamConstraints, workaroundWebKitBug180748, mediaStreamEventPublisher, mediaStream, mediaStreamTracks, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mediaStreamEventPublisher = fullOptions.mediaStreamEventPublisher;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                ...
                case 4:
                    ...
                    if (mediaStreamEventPublisher) {
                        if (error_1.name === 'NotAllowedError' || error_1.name === 'PermissionDeniedError') {
                            ...
                            mediaStreamEventPublisher.reportFailure(error_1);
                        }
                    }
