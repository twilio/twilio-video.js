...
var KRISP_VERSION = '1.0.0';
var RNNOISE_VERSION = '1.0.0';
            ...
            switch (_a.label) {
                ...
                case 4:
                    audioProcessor = {
                        ...
                        connect: function (sourceTrack) { return __awaiter(_this, void 0, void 0, function () {
                            var mediaStream, cleanTrack;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
