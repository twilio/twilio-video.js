...
function connectParticipant(room, participantSignaling) {
  var log = room._log,
      idleTrackSwitchOff = room._idleTrackSwitchOff,
      renderHints = room._renderHints;

  var participant = new RemoteParticipant(participantSignaling, { log: log, idleTrackSwitchOff: idleTrackSwitchOff, renderHints: renderHints });
