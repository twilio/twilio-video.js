 ...
 */
/**
 * Emitted when live transcription data is received.
...
function handleSignalingEvents(room, signaling) {
    ...
    signaling.on('liveTranscription', function (data) { return room.emit('liveTranscription', data); });
