...
function connectParticipant(room, participantSignaling) {
  var log = room._log,
      subscribedTrackSwitchOffMode = room._subscribedTrackSwitchOffMode,
      contentPreferencesMode = room._contentPreferencesMode;

  var participant = new RemoteParticipant(participantSignaling, { log: log, subscribedTrackSwitchOffMode: subscribedTrackSwitchOffMode, contentPreferencesMode: contentPreferencesMode });
