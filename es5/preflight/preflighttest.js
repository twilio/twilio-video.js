...
var PreflightTest = /** @class */ (function (_super) {
    ...
    PreflightTest.prototype._generatePreflightReport = function (collectedStats) {
        ...
        var mos = makestat_1.makeStat(collectedStats.mos);
        return {
            ...
            qualityScore: mos ? mos_1.mosToScore(mos.average) : 0,
    ...
    PreflightTest.prototype._collectRTCStats = function (collectedStats, senderPC, receiverPC) {
        return __awaiter(this, void 0, void 0, function () {
            var combinedStats, timestamp, bytesSent, bytesReceived, packets, packetsLost, roundTripTime, jitter, selectedIceCandidatePairStats, iceCandidateStats, hasLastData, fractionPacketLost, score;
            return __generator(this, function (_a) {
                switch (_a.label) {
