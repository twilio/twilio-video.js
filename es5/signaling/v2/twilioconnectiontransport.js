...
var TwilioConnectionTransport = /** @class */ (function (_super) {
    ...
    function TwilioConnectionTransport(name, accessToken, localParticipant, peerConnectionManager, wsServer, options) {
        ...
        Object.defineProperties(_this, {
            ...
            _enableLiveTranscription: {
                value: options.enableLiveTranscription
            },
            _eventObserver: {
    ...
    TwilioConnectionTransport.prototype._createConnectOrSyncOrDisconnectMessage = function () {
        ...
        if (message.type === 'connect') {
            ...
            message.media_signaling = createMediaSignalingPayload(this._dominantSpeaker, this._networkQuality, this._trackPriority, this._trackSwitchOff, this._adaptiveSimulcast, this._renderHints, this._enableLiveTranscription);
