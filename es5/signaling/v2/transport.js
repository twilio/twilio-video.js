...
var Transport = function (_StateMachine) {
  ...
  function Transport(name, accessToken, localParticipant, peerConnectionManager, ua, options) {
    ...
    var session = createSession(_this, name, accessToken, localParticipant, peerConnectionManager, ua, options.SIPJSMediaHandler, options.negotiateNetworkQuality, options.negotiateDominantSpeaker);
    ...
    setupEventListeners(_this, session, ua);
    return _this;
  }
