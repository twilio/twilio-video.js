...
var RoomV2 = /** @class */ (function (_super) {
    ...
    function RoomV2(localParticipant, initialState, transport, peerConnectionManager, options) {
        ...
        var _a = initialState.options.audio_processors, audioProcessors = _a === void 0 ? [] : _a;
    ...
    RoomV2.prototype._update = function (roomState) {
        ...
        this._updateMediaStates(roomState);
        return this;
    };
    /**
     * @private
    ...
    RoomV2.prototype._handleSubscriptions = function () {
        ...
        trackSidsToTrackSignalings.forEach(function (trackSignaling) {
            var trackId = _this._trackSidsToTrackIds.get(trackSignaling.sid);
     ...
     * @private
     */
    RoomV2.prototype._updateMediaStates = function (roomState) {
    ...
    RoomV2.prototype._updateSubscribed = function (_a) {
        ...
        subscribed.tracks.forEach(function (trackState) {
            if (trackState.id) {
                ...
                _this._trackSidsToTrackIds.set(trackState.sid, trackState.id);
            }
        ...
        this._trackSidsToTrackIds.forEach(function (trackId, trackSid) {
            if (!subscribedTrackSids.has(trackSid)) {
                _this._trackSidsToTrackIds.delete(trackSid);
            }
        });
    };
...
function filterAndAddRemoteTrackSids(roomV2, remoteTrackStats) {
    var idToSid = new Map(Array.from(roomV2._trackSidsToTrackIds.entries()).map(function (_a) {
