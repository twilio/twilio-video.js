...
var LiveTranscriptionSignaling = require('./livetranscriptionsignaling');
...
var RoomV2 = /** @class */ (function (_super) {
    ...
    function RoomV2(localParticipant, initialState, transport, peerConnectionManager, options) {
        ...
        options = Object.assign({
            ...
            LiveTranscriptionSignaling: LiveTranscriptionSignaling,
        ...
        Object.defineProperties(_this, {
            ...
            _liveTranscriptionSignaling: {
                value: new options.LiveTranscriptionSignaling(getTrackReceiver, { log: log })
            },
        ...
        _this._initLiveTranscriptionSignaling();
    ...
    RoomV2.prototype._update = function (roomState) {
        ...
        [
            ...
            this._liveTranscriptionSignaling,
    ...
    RoomV2.prototype._initLiveTranscriptionSignaling = function () {
        var _this = this;
        this._liveTranscriptionSignaling.on('transcription', function (data) {
            _this.emit('liveTranscription', data);
        });
    };
