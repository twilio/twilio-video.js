...
var _a = require('../../webrtc'), DefaultRTCIceCandidate = _a.RTCIceCandidate, DefaultRTCPeerConnection = _a.RTCPeerConnection, DefaultRTCSessionDescription = _a.RTCSessionDescription, getStatistics = _a.getStats, getTrackStatistics = _a.getTrackStats;
var util = require('../../webrtc/util');
var _b = require('../../util/constants'), DEFAULT_ICE_GATHERING_TIMEOUT_MS = _b.DEFAULT_ICE_GATHERING_TIMEOUT_MS, DEFAULT_LOGGER_NAME = _b.DEFAULT_LOGGER_NAME, DEFAULT_SESSION_TIMEOUT_SEC = _b.DEFAULT_SESSION_TIMEOUT_SEC, iceRestartBackoffConfig = _b.iceRestartBackoffConfig;
...
var _e = require('../../util'), getPlatform = _e.getPlatform, isChromeScreenShareTrack = _e.isChromeScreenShareTrack, oncePerTick = _e.oncePerTick, defer = _e.defer;
...
var PeerConnectionV2 = /** @class */ (function (_super) {
    ...
    function PeerConnectionV2(id, encodingParameters, preferredCodecs, options) {
        ...
        var log = options.log ? options.log.createLog(_this) : new Log(_this, options.loggerName);
     ...
     */
    PeerConnectionV2.prototype.getRemoteTrackStats = function (mediaStreamTrack) {
        var _this = this;
        return getTrackStatistics(this._peerConnection, mediaStreamTrack, { isRemote: true })
            .then(function (_a) {
            var _b = __read(_a, 1), stats = _b[0];
            return rewriteTrackId(_this, stats);
        });
    };
    /**
...
function updateEncodingParameters(pcv2) {
    ...
    var maxBitrates = new Map([
        ['audio', maxAudioBitrate * 1000],
        ['video', maxVideoBitrate * 1000]
    ]);
    var promises = [];
