  ...
  _createClass(PeerConnectionV2, [{
    ...
    value: function _answer(offer) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this3._peerConnection.localDescription ? _this3._maybeReoffer(_this3._peerConnection.localDescription) : Promise.resolve(false);
    ...
    value: function _updateDescription(description) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this10._peerConnection.localDescription ? _this10._maybeReoffer(_this10._peerConnection.localDescription).then(function () {}) : Promise.resolve();
      });
    }
