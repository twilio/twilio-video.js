...
var PeerConnectionV2 = function (_StateMachine) {
  ...
  _createClass(PeerConnectionV2, [{
    ...
    value: function _setLocalDescription(description) {
      ...
      var updatedDescription = description.type !== 'rollback' && this._enableDtxForOpus ? new this._RTCSessionDescription({ sdp: enableDtxForOpus(description.sdp), type: description.type }) : description;

      return this._peerConnection.setLocalDescription(updatedDescription).catch(function (error) {
