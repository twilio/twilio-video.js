...
var unifiedPlanRewriteNewTrackIds = require('../../util/sdp').unifiedPlanRewriteNewTrackIds;
...
var PeerConnectionV2 = function (_StateMachine) {
  ...
  _createClass(PeerConnectionV2, [{
    ...
    value: function _rewriteLocalTrackIds(description) {
      ...
      var sdp1 = unifiedPlanRewriteTrackIds(description.sdp, midsToTrackIds);
      ...
      var sdp2 = unifiedPlanRewriteNewTrackIds(sdp1, newTrackIdsByKind);
