  ...
  _createClass(PeerConnectionV2, [{
    ...
    value: function _addIceCandidate(candidate) {
      ...
      return Promise.resolve().then(function () {
        if (candidate || isEdge) {
          // NOTE(syerrapragada): candidate is null when signaling end-of-candidates on Edge
          candidate = candidate && new _this2._RTCIceCandidate(candidate);
    ...
    value: function _updateIce(iceState) {
      ...
      // NOTE(syerrapragada): signal end-of-candidates on Edge
      if (isEdge && iceState.complete) {
