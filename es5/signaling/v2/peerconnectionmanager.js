...
var _require = require('@twilio/webrtc'),
    RTCPeerConnection = _require.RTCPeerConnection;
...
var PeerConnectionManager = function (_QueueingEventEmitter) {
  ...
  function PeerConnectionManager(iceServerSource, encodingParameters, preferredCodecs, options) {
    ...
    options = Object.assign({
      ...
      // PeerConnectionV2.
      audioContextFactory: isFirefox && !RTCPeerConnection.prototype.addTransceiver ? require('../../webaudio/audiocontext') : null,
  ...
  _createClass(PeerConnectionManager, [{
    ...
    value: function setTrackSenders(trackSenders) {
      ...
      var mediaTrackSenders = new Set([this._dummyAudioTrackSender].concat(trackSenders).filter(function (trackSender) {
