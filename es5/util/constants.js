...
module.exports.WS_SERVER_TWILIOCONNECTION = function (environment, realm) {
  return environment === 'prod' ? 'wss://sdkgw.' + realm + '.twilio.com/signaling' : 'wss://sdkgw.' + environment + '-' + realm + '.twilio.com/signaling';
};
