...
function isSupported() {
  ...
  return isGetUserMediaSupported() && isRTCPeerConnectionSupported() && !!browser && (!rebrandedChrome || SUPPORTED_CHROME_BASED_BROWSERS.includes(rebrandedChrome)) && !isNonChromiumEdge(browser);
}
