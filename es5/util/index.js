...
function createRoomConnectEventPayload(connectOptions) {
  ...
  if (connectOptions.bandwidthProfile && connectOptions.bandwidthProfile.video) {
    ...
    ['mode', 'maxTracks', 'trackSwitchOffMode', 'dominantSpeakerPriority', 'maxSubscriptionBitrate', 'renderDimensions', 'contentPreferencesMode', 'subscribedTrackSwitchOffMode'].forEach(function (prop) {
