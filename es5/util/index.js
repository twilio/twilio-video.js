...
function getSdpFormat(sdpSemantics) {
  ...
  return browser === 'firefox' || sdpSemantics === 'unified-plan' && checkIfSdpSemanticsIsSupported() ? 'unified' : browser === 'safari' || RTCPeerConnection.prototype.addStream ? 'planb' : 'unified';
}
