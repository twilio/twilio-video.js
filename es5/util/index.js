...
function createRoomConnectEventPayload(connectOptions) {
    ...
    // boolean properties.
    [['audio'], ['automaticSubscription'], ['enableDscp'], ['preflight'], ['video'], ['dominantSpeaker', 'enableDominantSpeaker']].forEach(function (_a) {
    ...
    if (connectOptions.bandwidthProfile && connectOptions.bandwidthProfile.video) {
        ...
        ['mode', ['maxSwitchedOnTracks', 'maxVideoTracks'], 'trackSwitchOffMode', 'dominantSpeakerPriority', 'maxSubscriptionBitrate', 'contentPreferencesMode', 'clientTrackSwitchOffControl'].forEach(function (prop) {
...
function createBandwidthProfileVideoPayload(bandwidthProfileVideo) {
    return createRSPPayload(bandwidthProfileVideo, [
        ...
        { prop: 'maxSubscriptionBitrate', type: 'number', payloadProp: 'max_subscription_bandwidth', transform: function (val) { return val * 1000; } },
        { prop: 'maxSwitchedOnTracks', type: 'number', payloadProp: 'max_tracks' },
