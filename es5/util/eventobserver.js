...
/**
 * EventObserver listens to SDK events and re-emits them on the Logger with some additional information.
...
var EventObserver = /** @class */ (function (_super) {
     ...
     * @param {Log} log
     */
    function EventObserver(publisher, connectTimestamp, log) {
