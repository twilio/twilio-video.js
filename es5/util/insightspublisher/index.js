...
var _require2 = require('../endpoints'),
    getInsightsEndpoint = _require2.getInsightsEndpoint;
...
var InsightsPublisher = function (_EventEmitter) {
   ...
   */
  function InsightsPublisher(token, sdkName, sdkVersion, environment, region, options) {
    ...
    options = Object.assign({
      gateway: getInsightsEndpoint(environment, region),
